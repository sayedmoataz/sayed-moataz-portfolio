...
const TimelineDot = ({ isActive, isEducation, colors }) => (
    <Box
        sx={{
            ...
            height: { xs: 18, md: 24 },
            borderRadius: '50%',
            bgcolor: isActive ? (isEducation ? colors.secondary : colors.primary) : 'rgba(255, 255, 255, 0.2)',
            border: `3px solid ${isActive ? (isEducation ? colors.secondary : colors.teal) : 'rgba(255, 255, 255, 0.3)'}`,
            transform: { md: 'translateX(-50%)' },
            transition: 'all 0.6s ease-in-out',
            boxShadow: isActive ? `0 0 20px ${isEducation ? colors.secondary : colors.primary}` : 'none',
            zIndex: 2,
            display: 'flex',
            alignItems: 'center',
...
const ExperienceCard = ({ experience, colors, index, isActive }) => {
    ...
    return (
        ...
        >
            <TimelineDot isActive={isActive} isEducation={isEducation} colors={colors} />
                ...
                >
                    ...
                    <Stack direction="row" justifyContent="space-between" alignItems="flex-start" mb={2}>
                        <Box flex={1}>
                            ...
                            >
                                {isEducation ? <FaGraduationCap size={18} /> : <FaBriefcase size={16} />}
